...
- Files likely to change: `tools/drive_comparison_template.html`; `tools/drive_comparison_styles.css`; `tools/drive_comparison_client/ui/controls.js`; `tools/drive_comparison_client/presets/runtime.js`; `tools/drive_comparison_client/presets/library.js`; `tools/drive_comparison_client/main.js`; `tools/drive_comparison_i18n.py`; `tools/verify_drive_comparison_browser.mjs`; generated checked-in UI files under `docs/index.html` and `docs/assets/js/**` after the safe UI-only build.
